...
def main() -> int:
    ...
    steps.append(_run_step("research_skip_deep_mini", [str(ROOT / ".venv/bin/python"), "-m", "src.workflows.research_pipeline", "--skip-deep-mini"], timeout=args.research_timeout, env=env))
